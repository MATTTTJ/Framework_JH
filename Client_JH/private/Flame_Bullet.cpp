...
CFlame_Bullet::CFlame_Bullet(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	:CBullet(pDevice, pContext)
{
}

CFlame_Bullet::CFlame_Bullet(const CFlame_Bullet& rhs)
	: CBullet(rhs)
{
}

HRESULT CFlame_Bullet::Initialize_Prototype()
{
...
HRESULT CFlame_Bullet::Initialize_Clone(const wstring& wstrPrototypeTag, void* pArg)
{
	...
	if (nullptr != pArg)
	{
		...
		m_tBulletOption.BulletDesc.m_iDamage = 50;
...
void CFlame_Bullet::Tick(_double dTimeDelta)
{
...
void CFlame_Bullet::Late_Tick(_double dTimeDelta)
{
...
HRESULT CFlame_Bullet::SetUp_Component()
{
...
HRESULT CFlame_Bullet::SetUp_ShaderResources()
{
...
// _bool CFlame_Bullet::Collision_Body()
// {
...
CFlame_Bullet* CFlame_Bullet::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CFlame_Bullet*		pInstance = new CFlame_Bullet(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CFlame_Bullet");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CFlame_Bullet::Clone(const wstring& wstrPrototypeTag, void* pArg)
{
	CFlame_Bullet*		pInstance = new CFlame_Bullet(*this);

	if (FAILED(pInstance->Initialize_Clone(wstrPrototypeTag, pArg)))
	{
		MSG_BOX("Failed to Cloned : CFlame_Bullet");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CFlame_Bullet::Free()
{
