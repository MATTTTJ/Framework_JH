...
HRESULT CHome::Render_ShadowDepth()
{
...
HRESULT CHome::SetUp_Components()
{
	...
	FAILED_CHECK_RETURN(__super::Add_Component(LEVEL_GAMEPLAY, L"Prototype_Component_Model_Lobby", L"Com_Model", (CComponent**)&m_pModelCom, this), E_FAIL);
