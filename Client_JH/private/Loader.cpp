...
HRESULT CLoader::Loading_For_GamePlay()
{
	...
	// 플레이어 스킬
	FAILED_CHECK_RETURN(pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, L"Prototype_Component_Texture_UI_PlayerSkillOn", CTexture::Create(m_pDevice, m_pContext, L"../Bin/Resources/UI/Player_UI/InGame_PlayerUI/img_skillbg_On.png", 1)), E_FAIL);
