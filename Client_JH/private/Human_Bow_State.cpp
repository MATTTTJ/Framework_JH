...
HRESULT CHuman_Bow_State::Initialize(CHuman_Bow* pOwner, CState* pStateMachineCom, CModel* pModel, CTransform* pTransform, CNavigation* pNavigation)
{
	return S_OK;
}
...
HRESULT CHuman_Bow_State::SetUp_State_No_Detected()
{
	return S_OK;
...
HRESULT CHuman_Bow_State::SetUp_State_Walk()
{
	return S_OK;
}
...
HRESULT CHuman_Bow_State::SetUp_State_Attack_B()
{
	return S_OK;
}
...
void CHuman_Bow_State::Start_No_Detected(_double dTimeDelta)
{
}
...
void CHuman_Bow_State::Start_Walk(_double dTimeDelta)
{
}
...
void CHuman_Bow_State::Start_Attack_B(_double dTimeDelta)
{
}
...
void CHuman_Bow_State::Tick_No_Detected(_double dTimeDelta)
{
}
...
void CHuman_Bow_State::Tick_Walk(_double dTimeDelta)
{
}
...
void CHuman_Bow_State::Tick_Attack_B(_double dTimeDelta)
{
}
...
void CHuman_Bow_State::End_No_Detected(_double dTimeDelta)
{
}
...
void CHuman_Bow_State::End_Walk(_double dTimeDelta)
{
}
...
void CHuman_Bow_State::End_Attack_B(_double dTimeDelta)
{
}
