...
{
public:
	enum RENDERGROUP { RENDER_PRIORITY, RENDER_DYNAMIC_SHADOWDEPTH, RENDER_NONALPHABLEND, RENDER_OUTLINE,  RENDERER_LIGHTACC, RENDER_NONLIGHT, RENDER_BLUR,RENDER_FADE, RENDER_ALPHABLEND, RENDER_EFFECT, RENDER_UI,RENDER_GLOW, RENDER_END };
