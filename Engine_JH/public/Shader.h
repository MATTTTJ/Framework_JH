...
{
public:
	enum DECLARATIONTYPE { DECLARATION_VTXTEX, DECLARATION_VTXNORTEX,DECLARATION_VTXMODEL,DECLARATION_VTXANIMMODEL, DECLARATION_VTXPOS,DECLARATION_VTXCUBE, DECLARATION_END	};
